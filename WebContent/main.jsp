...
<div region="north" style="height: 78px; background: #E0ECFF;">
	<table style="padding: 5px; width: 100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;欢迎：<strong>${currentUser.userName }</strong></font>【${currentUser.trueName }】【${currentUser.roleName }】
			</td>
		</tr>
	</table>
</div>
...
<div region="west" style="width: 200px;" title="导航菜单" split="true"><!-- split 可伸缩属性 -->
	<div class="easyui-accordion" data-options="fit: true, border: false">
		<div title="营销管理" data-options="selected: true, icons: 'icon-yxgl'" style="padding: 10px;">
			<a href="javascript: openTab('营销计划管理','saleChanceManage.jsp','icon-yxjhgl')" class="easyui-linkbutton"
				data-options="plain: true, iconCls: 'icon-yxjhgl'" style="150px;">营销计划管理</a>
			<a href="javascript: openTab('客户开发计划','cusdevplanManage.jsp','icon-khkfjh')" class="easyui-linkbutton"
				data-options="plain: true, iconCls: 'icon-khkfjh'" style="150px;">客户开发计划</a>
		</div>
...
<div id="dlg" class="easyui-dialog" title="修改密码" modal="true" closed="true" buttons="#dlg-buttons" style="width:350px; padding: 10px;">
	<form id="fm" action="${pageContext.request.contextPath}/user/modifyPassword.do" method="post">
		<table cellspacing="8px;">
			<tr>
				<td>用户名：</td>
				<td>
				<input id="id" name="id" type="hidden" readonly="readonly" value="${currentUser.id }">
				<input id="userName" name="userName" type="text" readonly="readonly" value="${currentUser.userName }">
				</td>
			</tr>
			<tr>
				<td>原密码：</td>
				<td>
				<input id="oldPassword" name="oldPassword" class="easyui-validatebox" type="password" required="true">
				</td>
			</tr>
			<tr>
				<td>新密码：</td>
				<td>
				<input id="newPassword" name="password" class="easyui-validatebox" type="password" required="true">
				</td>
			</tr>
			<tr>
				<td>确认新密码：</td>
				<td>
				<input id="newPassword2" name="newPassword2" class="easyui-validatebox" type="password" required="true">
				</td>
			</tr>
		</table>
	</form>
</div>
<div id="dlg-buttons" class="easyui-buttion">
	<a href="javascript:modifyPassword()" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
	<a href="javascript:cancelModifyPassword()" class="easyui-linkbutton" iconCls="icon-cancel">取消</a>
</div>
</body>
</html>