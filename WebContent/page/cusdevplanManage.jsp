...
<script type="text/javascript">
	...
	function formateDevResult(value, row, index){
		if(value==0){
			return "未开发";
		}else if(value==1){
			return "开发中";
	...
	function formateAction(value, row, index){
		var dr = row.devResult;
		if(dr==0 || dr==1){
	...
	function openCusDevPlanTab(id){
		window.parent.openTab("开户开发计划项管理","cusdevplanitemManage.jsp?saleChanceId="+id,"icon-khkfjh");
	}
...
<table id="dg" title="客户开发计划管理" class="easyui-datagrid" data-options="fitColumns:true,pagination:true,rownumbers:true,
	...
	<thead>
		...
		<th field="state" width="100" align="center" formatter="formatState" hidden="true">状态</th><!-- 分配状态 0 未分配 1 已分配 -->
		<th field="devResult" width="100" align="center" formatter="formateDevResult">客户开发状态</th><!-- 客户开发状态 0 未开发 1 开发中 2 开发成功 3 开发失败 -->
		<th field="action" width="80" align="center" formatter="formateAction">操作</th>
		</tr>
	</thead>	
</table>
<div id="tb">
	<div>
		...
		&nbsp;客户开发状态：<select type="text" class="easyui-combobox" id="s_devResult" editable="false" panelHeight="auto" style="width:100px;">
