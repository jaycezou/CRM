...
$(function(){
	...
	$("#dg").edatagrid({
		url:'${pageContext.request.contextPath}/contact/list.do?saleChanceId=${param.cusId}',
...
<br>
<table id="dg" title="交往记录管理" style="width: 700px; height: 250px;" toolbar="#tb" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
	<thead>
		<tr>
